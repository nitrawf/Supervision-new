...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="AddBlock.aspx">Go &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="AssignDesignation.aspx">Go &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="RequestExemption.aspx">Go &raquo;</a>
            </p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="AssignRoom.aspx">Go &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>Reports</h2>
