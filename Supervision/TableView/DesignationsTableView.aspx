<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" AutoEventWireup="true" CodeFile="DesignationsTableView.aspx.cs" Inherits="TableView_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:gridview runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="DesignationID" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical">
